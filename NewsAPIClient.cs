...
namespace APIVerve
{
    public class NewsAPIClient
    {
        ...
        public NewsAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public NewsAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, newsQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(newsQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(newsQueryOptions options)
        {
